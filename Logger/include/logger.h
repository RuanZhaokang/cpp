...
public:
	...
	void setOutput(LogOutput* output) { setOutput(std::unique_ptr<LogOutput>(output)); }
	void setFormater(LogFormat* formater) { setFormater(std::unique_ptr<LogFormat>(formater)); }
